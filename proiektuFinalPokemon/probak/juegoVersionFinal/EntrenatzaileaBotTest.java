...
public class EntrenatzaileaBotTest {
	EntrenatzaileaBot e1;
	Pokemon p1;
	...
	public void testErabiliMugimendu() {
		...
		//ezin da proba zehatzak egin, erabilitako mugimendua aletorioki esleituta dagoelako
		assertNotNull(e1.erabiliMugimendu(p1));
	}

	@Test
	public void testEntrenatzaileaBot() {
		assertNotNull(e1);
		assertNotNull(p1);
		assertNotNull(m1);
		assertNotNull(m2);
